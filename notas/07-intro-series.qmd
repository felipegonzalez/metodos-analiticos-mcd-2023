...
están generalmente dentro de la banda señalada por las líneas punteadas.
...
en términos de la correlación entre $y_t$ y $y_{t-1}$, 
y podemos interpretar como el efecto directo de $y_{t-1}$ sobre $y_t$.
...
más en [nuestra referencia Forecasting: Principles and Practice](https://otexts.com/fpp3/arima.html).
